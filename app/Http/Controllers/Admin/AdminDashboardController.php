...
class AdminDashboardController extends Controller
{
    public function index(): View
    {
        ...
        // Statistik Berita
        $totalPos = \App\Models\Berita::count();
        $totalBerita = \App\Models\Berita::where('category', 'berita')->count();
        $totalKegiatan = \App\Models\Berita::where('category', 'kegiatan')->count();
