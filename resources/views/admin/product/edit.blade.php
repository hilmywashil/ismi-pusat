        ...
        <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" id="product_name" name="product_name"
                    ...
                    value="{{ old('product_name', $product->product_name) }}" placeholder="Masukkan nama product">
                @error('product_name')
                ...
                <div class="file-input-wrapper">
                    ...
                    <label for="image" class="file-label">
                        <div>
                            ...
                            <div style="font-weight: 600;">Klik untuk upload gambar baru</div>
                            <div style="font-size: 0.75rem; color: #6b7280;">Kosongkan jika tidak ingin mengganti</div>
                        </div>
                    </label>
                </div>
